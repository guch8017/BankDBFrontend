...
public class FragmentStatDetail extends Fragment implements NetworkUtil.INetworkCallback<ModelStatResponse> {
    ...
    static class StatAdapter extends ArrayAdapter<ModelStatResponse.Stat1>{
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            cv.setText(String.valueOf(item.count));
            return convertView;
        }
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dialogView.findViewById(R.id.btn_ok).setOnClickListener(v1 -> {
            ...
            new NetworkUtil<ModelStatResponse>().doRequestWithSession(Static.STAT_GET, new ModelStat(start, end), FragmentStatDetail.this, ModelStatResponse.class);
            dialog.dismiss();
        });
        dialog.show();
        return v;
